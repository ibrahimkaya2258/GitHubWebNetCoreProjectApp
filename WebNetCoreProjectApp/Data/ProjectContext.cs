...
namespace WebNetCoreProjectApp.Data
{
    public class ProjectContext:DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<WebSitePassword>().HasMany(e => e.PasswordHistories).WithOne(e => e.WebSitePassword).HasForeignKey(e => e.WebSitePasswordId).OnDelete(DeleteBehavior.Cascade);
