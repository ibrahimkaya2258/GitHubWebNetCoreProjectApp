...
namespace WebNetCoreProjectApp.Controllers
{
    public class WebSitePasswordController : Controller
    {
        ...
        public WebSitePasswordController(ProjectContext db, IPasswordGenerator passwordGenerator = null)
        {
            _db = db;
        ...
        [HttpPost]
        public JsonResult GeneratePassword(GeneratePasswordViewModel generatePasswordViewModel)
        {

           string password= _passwordGenerator.GeneratePassword(generatePasswordViewModel.PasswordLenght,generatePasswordViewModel.UpperCaseLenght,generatePasswordViewModel.LowerCaseLenght,generatePasswordViewModel.SpecialCharLenght,generatePasswordViewModel.NumericCharLenght);
